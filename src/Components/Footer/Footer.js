...
const Footer = () => {
    return (
        <div>
            <footer className="text-gray-400 custom-bg2 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            <h2 className="title-font text-green-400 font-medium text-white tracking-widest text-sm mb-3">Our Branches</h2>
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-green-400 tracking-widest text-sm mb-3">Important Links</h2>
                            <nav className="list-none mb-10">
                                <li>
                ...
                <div className="bg-gray-800 bg-opacity-75">
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
                            <img src="https://raw.githubusercontent.com/shahriarmehedi/simple-nav/main/logo-4.png" alt="" />
